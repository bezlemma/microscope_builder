...
import { Ray, HitRecord, InteractionResult, Complex, childRay } from '../physics/types';
...
export class Waveplate extends OpticalComponent {
    ...
    intersect(rayLocal: Ray): HitRecord | null {
        // Thin-plane intersection at w=0 (optical axis along x (w) → w)
        ...
        const normal = new Vector3(0, 0, dw > 0 ? -1 : 1);  // ±w normal facing incoming ray
