...
export function createWasmPackedInteractionBackend(
    ...
    if (typeof module.exports.solver3_apply_packed_interaction !== 'function') return null;
    if (typeof module.exports.solver3_interaction_input_stride !== 'function') return null;
    if (typeof module.exports.solver3_interaction_output_stride !== 'function') return null;
    if (module.exports.solver3_interaction_input_stride() !== PACKED_INTERACTION_INPUT_STRIDE) return null;
    if (module.exports.solver3_interaction_output_stride() !== PACKED_INTERACTION_OUTPUT_STRIDE) return null;
    ...
    function tryInteract(componentIndex: number, ray: Ray, hit: HitRecord): InteractionResult | null {
        ...
        const handled = module.exports.solver3_apply_packed_interaction!(
            headerPtr,
            localToWorldPtr,
            interactionKindsPtr,
            surfaceParamsPtr,
