...
export const createTransFluorescenceScene = (): OpticalComponent[] => {
    ...
    focusingLens.setRotation(0, Math.PI / 2, 0); // convex side faces laser
    ...
    condenser1.setRotation(0, Math.PI / 2, 0);
    ...
    condenser2.setRotation(0, Math.PI / 2, 0);
    ...
    camera.setRotation(Math.PI / 2, -Math.PI / 2, 0);
    scene.push(camera);
